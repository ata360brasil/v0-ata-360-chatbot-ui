...
- Fallback: "[Cidade] faz parte dos municipios que estao se adaptando a Lei 14.133."

Exemplos de desafios:
- Se populacao < 10 mil: "Equipe reduzida. O ATA360 foi pensado para multiplicar essa equipe."
- Se processos abaixo da media: "Adaptacao ao PNCP. O ATA360 ajuda a regularizar."
...
3 micro-metricas:
- Por documento: R$ [calc]/documento
- Por habitante/mes: R$ [calc]/habitante
- Por dia: R$ [calc]/dia
...
## O QUE ESTA INCLUSO (lista visual)
...
- Licenca por assento
- Taxa por consulta
- Limite de documentos/mes
- Add-on de assinatura
- Modulo premium
- Suporte pago
...
1. Faca o cadastro
   Informe o CNPJ e seus dados. Em minutos, seu ambiente esta pronto com dados reais do seu orgao.

2. Acesse o ATA360
   Explore a plataforma. Use com um processo real. Seus 14 dias de avaliacao comecam agora.

3. Pronto.
   O ATA360 gera os documentos da propria contratacao: ETP, TR, pesquisa de precos, proposta comercial, justificativas tecnicas e comparativo com outras solucoes. So assinar.

Micro-copy: O processo de contratacao leva em media 5 dias uteis. Se iniciar pela plataforma, estendemos seu acesso ate a conclusao.
...
## Anti-abuso da calculadora
- Rate limit: max 5 consultas/hora por IP
- Rate limit: max 3 CNPJs diferentes por sessao
- CAPTCHA inteligente: so aparece na 2a consulta
